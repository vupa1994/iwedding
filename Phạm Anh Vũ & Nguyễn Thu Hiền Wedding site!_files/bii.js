...
.bii-logo{position: fixed;bottom: 70px;right: 50px;width: 50px;height: 50px;z-index:99999;}
...
.bii-logo-secondary-content{position: absolute;width: 350px;right: -25px;background: #fff;height: 50px;padding: 13px 53px 13px 11px;border: 1px solid #df4759;border-radius: 30px;z-index: 9999;font-size:15px;transform: translate3d(100%, 0, 0);transition: transform 175ms ease;font-family: arial;font-weight: 200;color: #000;}</style>
<!--<div class="bii-logo"><div class="bii-logo-secondary"><div class="bii-logo-secondary-content">Nền tảng tạo Website đám cưới miễn phí!</div></div><a href="${biicore.coreSite}/vi/wedding" target="_blank"><img src="${biiLogo}" /></a></div>-->
